...
class HelpersTest(test_utils.FakeTaskTest):
    ...
    def test_mixture_new_vocab(self):
        ...
        test_dataset_fn1 = functools.partial(_dataset_fn, data=["this is", "a test"])
        ...
        self.assertEqual(new_submix_subtask1.preprocessors, test_task1.preprocessors)
        self.assertEqual(new_submix_subtask2.source, test_task2.source)
        self.assertEqual(new_submix_subtask2.preprocessors, test_task2.preprocessors)
    ...
    def test_mixture_new_output_features(self):
        ...
        self.assertDictEqual(new_submix_subtask1.output_features, new_output_features)
        self.assertDictEqual(new_submix_subtask2.output_features, new_output_features)
